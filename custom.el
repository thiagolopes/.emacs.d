...
(custom-set-variables
 ...
 '(package-selected-packages
   '(anzu buffer-name-relative cape cmake-mode
          consult corfu-terminal diminish dockerfile-mode dumb-jump
          eglot exec-path-from-shell expand-region expreg flycheck
          flyover git-link git-timemachine goto-last-change
          ...
          no-littering nvm org-modern page-break-lines popwin
